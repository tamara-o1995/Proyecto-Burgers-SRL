...
{
    protected $table = 'sistema_menues'; //NOMBRE DE LA TABLA DE LA BASE DE DATOS (PROPIEDAD)
    public $timestamps = false;

    protected $fillable = [
        //INDICA CUALES SON LOS NOMBRES DE LAS COLUMNAS DE LA BBDD (CAMPOS)
    ...
    {
        //columnas nombradas de la tabla
        $request = $_REQUEST;
        $columns = array(
            0 => 'A.nombre',
            1 => 'B.nombre',
    ...
    public function insertar()
    {
        ...
        return $this->idmenu = DB::getPdo()->lastInsertId(); //INSERTA Y OBTENEMOS EL ULTIMO ID INSERTADO
    }
