...
if (!defined('VENTA_ENTREGADO')) define("VENTA_ENTREGADO", "2");
if (!defined('VENTA_CONFIRMADO')) define("VENTA_CONFIRMADO", "3");
if (!defined('VENTA_CANCELADO')) define("VENTA_CANCELADO", "4");
