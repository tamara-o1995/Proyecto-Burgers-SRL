...
class ControladorPatente extends Controller
{
    ...
    public function cargarGrilla()
    {
        ...
        $json_data = array(
            ...
            "data" => $data, //tienen que viajar todos los datos y todo codificado en jason
        );
    ...
    public function guardar(Request $request) //es lo mismo que $nombre = $_REQUEST["txtNombre"]
    {
        try {
