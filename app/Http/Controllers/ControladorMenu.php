...
use Illuminate\Http\Request; //nos provee de seguridad, nos trae los datos del formulario pero filtra si alguien quiere hackear
...
class ControladorMenu extends Controller
{
    ...
    public function nuevo()
    {
     ...
     //devuelve la vista ('carpeta.archivo', compact (permite enviar variables del controlador a la vista)) esto es igual que decir "array("titulo" => $titulo, "array_menu" => $array_menu);"

    }

    public function editar($id) //el id para la ruta se obtiene por parametro
    {
        ...
        if (Usuario::autenticado() == true) {
            if (!Patente::autorizarOperacion("MENUMODIFICACION")) {
                ...
                $menu = new Menu();
                $menu->obtenerPorId($id); //viene por id (id de la ruta/url)
